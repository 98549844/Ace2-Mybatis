...
//    @After:           final增强, 不管是抛出异常或者正常退出都会执行
    ...
    @Pointcut("execution(public * com.ace2.mybatis.controller.*.*(..))")
    public void controllerAspect() {
    }


    @Before("execution(* com.ace2.mybatis.controller.*.*(..))")
    public void beforeUpdate() {
        System.out.println("com.ace2.mybatis.controller => beforeUpdate ...");
    }


    @After("execution(* com.ace2.mybatis.controller.*.*(..))")
    public void afterUpdate(JoinPoint jp) {
        System.out.println("com.ace2.mybatis.controller => afterUpdate ..."/*+users.getUserAccount()*/);
    }

    @Around("execution(* com.ace2.mybatis.controller.*.*(..))")
    public void aroundUpdate(ProceedingJoinPoint point) throws Throwable {
        ...
        System.out.println("com.ace2.mybatis.controller => aroundUpdate ..." + user.getUserAccount());
        System.out.println("com.ace2.mybatis.controller => aroundUpdate ..." + user.getVersion());
        System.out.println("com.ace2.mybatis.controller => aroundUpdate ..." + user.getLastUpdateDate());
    }
}
