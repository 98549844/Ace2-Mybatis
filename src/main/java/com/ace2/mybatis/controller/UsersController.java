...
import com.ace2.mybatis.generator.InsertUsers;
import com.ace2.mybatis.mapper.UsersMapper;
...
public class UsersController {
    ...
    public Users updateUserByMybatisPlus() {
        ...
        Users u = usersMapper.selectById(533l);
    ...
    public Users findUserByMybatis(@PathVariable String acc) {
        Users users = usersMapper.selectById(533l);
        return users;
    }
